create or replace function public.claim_fixed_21_push_reminders(
...
as $$
  ...
  due_groups as (
    ...
    where e.local_hour = 21
      and e.local_minute = 0
      and not exists (
        select 1
...
revoke execute on function public.claim_fixed_21_push_reminders(
  timestamptz,
  integer,
  text,
  text,
...
grant execute on function public.claim_fixed_21_push_reminders(
  timestamptz,
  integer,
  text,
  text,
